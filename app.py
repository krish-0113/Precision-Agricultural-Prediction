...
def weather_fetch(city_name):
    ...
    :params: city_name
    :return: temperature, humidity or None if city not found
    """
...
def disease_prediction():
    ...
    if request.method == 'POST':
        ...
        if file.filename == '':
            ...
            return render_template('disease.html', title=title, error="Please select a file.")
        ...
        try:
            ...
            prediction = disease_dic.get(label, "No description found for this disease.")
            return render_template('disease-result.html', prediction=Markup(prediction), title=title)
        
        except Exception as e:
            print(f"Prediction error: {e}")
            return render_template('disease.html', title=title, error="Error during prediction. Please try again.")
